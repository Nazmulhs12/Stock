                      ...
                      <div class="form-group">
                        ...
                        <div class="input-group">
                          <select class="form-control" name="color">
                              <option value="0 {{$product->color == 0 ? 'Selected': ''}}">Red</option>
                              <option value="1 {{$product->color == 1 ? 'Selected': ''}}">Green</option>   
                          </select>
                           <select class="form-control" name="size">
                              <option value="0 {{$product->size == 0 ? 'Selected': ''}}">SM</option>
                              <option value="1 {{$product->size == 1 ? 'Selected': ''}}">XL</option>
